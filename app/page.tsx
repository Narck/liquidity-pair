      ...
      <section id="about" className="about">
        ...
        <div className="about-grid">
          ...
          <div className="about-copy">
            ...
            <h2>METEORA MADE<br />LIQUIDITY POOLS.<br /><em>POWERED BY THE<br />BIGGEST PAIR OF<br />LIQUIDITY ON CHAIN.</em></h2>
            <div className="about-note">
              <p>One of the first coins to hit Ember. Paired directly with $MET.</p>
